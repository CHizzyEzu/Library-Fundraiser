...
int main()
    ...
    // Variable Declarations
        double week1money = 0, week2money = 0, raised_moneysum = 0, week1money_avg, week2money_avg;
        double pagesum = 0, week1page = 0, week2page = 0, week1page_avg = 0, week2page_avg = 0;
